...
import "./interfaces/ITradedTokenUpgradeable.sol";

//import "hardhat/console.sol";

contract TradedTokenUpgradeable is IClaim, OwnableUpgradeable, IERC777RecipientUpgradeable, IERC777SenderUpgradeable, ERC777Upgradeable, ReentrancyGuardUpgradeable, ITradedTokenUpgradeable, CostManagerHelper {
   // using FixedPoint for *;
        ...
        onlyInitializing 
    {
        ...
        (taxes_.buyTaxMax, taxes_.sellTaxMax, taxes_.holdersMax);
        ...
        external 
    {
        ...
        if (
            ...
            (
                !recipient.isContract() ||
                (_msgSender() != OwnableUpgradeable(recipient).owner())
            )
        ) {
            revert NotAuthorized();
        }
