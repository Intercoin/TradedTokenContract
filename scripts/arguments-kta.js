...
No taxes
Antipanic of 10%
USDC instead of BUSD as the reserve token for pool (pancakeswap on bsc, uniswap on eth)
Standard liquidity similar to Intercoin
*/
module.exports =  [
  "KTA Coin", // string memory tokenName_,
  "KTAX",// string memory tokenSymbol_,
